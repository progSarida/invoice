...
class EditBankAccount extends EditRecord
{
    ...
    protected function getDeleteFormAction()
    {
        return Actions\DeleteAction::make('delete')
                ...
                ->modalHeading('Conferma eliminazione conto bancario')
                ->modalDescription('Sei sicuro di voler eliminare questo conto bancario? Questa azione non può essere annullata.')
    ...
    protected function getCancelFormAction(): Actions\Action
    {
        return Actions\Action::make('cancel')
            ...
            ->color('gray')
            ->url(function () {
                if ($this->previousUrl && str($this->previousUrl)->contains('/bank-accounts?')) {
