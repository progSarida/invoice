...
class EditShipmentType extends EditRecord
{
    ...
    protected function getDeleteFormAction()
    {
        return Actions\DeleteAction::make('delete')
                ...
                ->modalHeading('Conferma eliminazione tipo spedizione')
                ->modalDescription('Sei sicuro di voler eliminare questo tipo sdi spedizione? Questa azione non può essere annullata.')
    ...
    protected function getCancelFormAction(): Actions\Action
    {
        return Actions\Action::make('cancel')
            ...
            ->color('gray')
            ->url(function () {
                if ($this->previousUrl && str($this->previousUrl)->contains('/shipment-types?')) {
                    return $this->previousUrl;
                }
                return ShipmentTypeResource::getUrl('index');
            });
    }
