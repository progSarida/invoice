...
class EditAttachment extends EditRecord
{
    ...
    protected function getDeleteFormAction()
    {
        return Actions\DeleteAction::make('delete')
                ...
                ->modalHeading('Conferma eliminazione allegato')
                ->modalDescription('Sei sicuro di voler eliminare questo allegato? Questa azione non può essere annullata.')
    ...
    protected function getCancelFormAction(): Actions\Action
    {
        return Actions\Action::make('cancel')
            ...
            ->color('gray')
            ->url(function () {
                if ($this->previousUrl && str($this->previousUrl)->contains('/attachments?')) {
                    return $this->previousUrl;
                }
                return AttachmentResource::getUrl('index');
            });
    }
