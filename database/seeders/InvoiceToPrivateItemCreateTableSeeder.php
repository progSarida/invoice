...
class InvoiceToPrivateItemCreateTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        try{
            ...
            // $invoices = Invoice::where('id', 2606)->get();                                          // fattura di test
            // $invoices = Invoice::where('id', 5197)->get();                                          // fattura di test
            // $invoices = Invoice::where('id', 6241)->get();                                          // fattura di test
            // $invoices = Invoice::whereIn('id', [2606, 5197, 6241])->get();                          // fatture di test
